...
import { UserPlus, Mail, Lock, User, ShoppingBag, Github } from 'lucide-react';
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              type="button"
              className="w-full flex items-center justify-center py-3 px-4 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
            >
